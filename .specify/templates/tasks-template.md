...
**Tests**: The examples below include test tasks. Include automated tests whenever behavior changes.
If automation is not feasible, add explicit manual validation tasks with clear acceptance steps.
...
- [ ] T012 [US1] Document manual validation in specs/[###-feature-name]/quickstart.md (only if tests omitted)
...
- [ ] T021 [US2] Document manual validation in specs/[###-feature-name]/quickstart.md (only if tests omitted)
...
- [ ] T028 [US3] Document manual validation in specs/[###-feature-name]/quickstart.md (only if tests omitted)
...
- [ ] TXXX Verify spec/plan/tasks traceability and constitution compliance
